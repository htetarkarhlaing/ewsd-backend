          ...
          >
            ...
            <tr>
              <td style="padding: 30px">
                ...
                <p>
                  Welcome to <strong>Apex Horizon University</strong>. You have
                  been invited as <strong>${role}</strong> to join
                  our system.
                </p>
                ...
                <p>
                  You can log in at:
                  <a
                    href="https://ewsd-frontend.vercel.app/admin/login"
                    target="_blank"
                    >https://ewsd-frontend.vercel.app/admin/login</a
                  >
                </p>
